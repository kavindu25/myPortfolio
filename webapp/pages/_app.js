    ...
    <Head>
        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <Link href="about"><a className="navbar-brand js-scroll-trigger" >
                ...
                <span className="d-none d-lg-block"><img className="img-fluid img-profile rounded-circle mx-auto mb-2" src="/profilepicnew.jpg" alt="" /></span>
            </a></Link>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item"><Link href="/awards"><a className="nav-link js-scroll-trigger">Experience</a></Link></li>
